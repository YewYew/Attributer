...
namespace attributer.src.patch
{
    ...
    internal class ItemWorkItemPatch
    {
        ...
        public static void GetRequiredAnvilTierItemWorkItem(ItemStack stack, ref int __result)
        {
        ...
        public static void CanWorkItemWorkItem(ItemStack stack, ref bool __result)
        {
