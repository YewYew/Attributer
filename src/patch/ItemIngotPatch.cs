...
namespace attributer.src.patch
{
    ...
    internal class ItemIngotPatch
    {
        [HarmonyPostfix]
        [HarmonyPatch("GetRequiredAnvilTier"), HarmonyPriority(Priority.First)]
        public static void GetRequiredAnvilTierItemIngot(ItemStack stack, ref int __result)
        {
        ...
        public static void CanWorkItemIngot(ItemStack stack, ref bool __result)
        {
